...
class decoder(nn.Module):
    ...
    def forward(self, x5_res3, x4, x3, x2):
        ...
        # print("act1_dec2 shape:", act1_dec2.shape)
        # print("skip_2 shape:", skip_2.shape)

        if skip_2.shape[-2:] != act1_dec2.shape[-2:]:  # Check spatial dimensions
            skip_2 = F.interpolate(skip_2, size=act1_dec2.shape[-2:], mode='bilinear', align_corners=False)
